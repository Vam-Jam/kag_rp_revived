...
void onMainMenuCreated(CRules@ this, CContextMenu@ menu)
{
	...
	CContextMenu@ changeDiplomat = Menu::addContextMenu(menu, "Test");
	Menu::addSeparator(menu);
	//vote options menu

	//Change diplomat menu

	if(me.get_u8("Team") == 1)
	{
		CContextMenu@ team1Menu = Menu::addContextMenu(changeDiplomat, "Elves");
		Menu::addSeparator(changeDiplomat);
		CContextMenu@ team2Menu = Menu::addContextMenu(changeDiplomat, "Race 2/alliance 2");
		Menu::addSeparator(changeDiplomat);
		...
		if(this.get_u8("1 2") == 0)
			...
			status = "ALLIES";
		CContextMenu@ team1Status = Menu::addContextMenu(team1Menu, status);
		Menu::addSeparator(team1Menu);
		CContextMenu@ team1War = Menu::addContextMenu(team1Menu, "War");
		CContextMenu@ team1Neutral = Menu::addContextMenu(team1Menu, "Neutral");
		CContextMenu@ team1Allies = Menu::addContextMenu(team1Menu, "Aliies");
	}
