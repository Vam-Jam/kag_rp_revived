...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks)
{
	...
	{
		BuildBlock b(CMap::tile_stonewall, "stone_block", "$tile_stonewall$", "Stone Block\nBasic building block");
		//AddRequirement(b.reqs, "blob", "mat_stone", "Stone", BuilderCosts::stone_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_stonebackground, "back_stone_block", "$tile_stonebackground$", "Back Stone Wall\nExtra support");
	...
	{
		BuildBlock b(CMap::tile_woodwall, "wood_block", "$tile_woodwall$", "Wood Block\nCheap block\nwatch out for fire!");
		//AddRequirement(b.reqs, "blob", "mat_wood", "Wood", BuilderCosts::wood_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_woodbackground, "back_wood_block", "$tile_woodbackground$", "Back Wood Wall\nCheap extra support");
		//AddRequirement(b.reqs, "blob", "mat_wood", "Wood", BuilderCosts::back_wood_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_copperwall, "stone_block", "$tile_copperwall$", "Stone Block\nBasic building block");
		//AddRequirement(b.reqs, "blob", "mat_stone", "Stone", BuilderCosts::stone_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_ironwall, "stone_block", "$tile_copperwall$", "Stone Block\nBasic building block");
		//AddRequirement(b.reqs, "blob", "mat_stone", "Stone", BuilderCosts::stone_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_goldwall, "back_wood_block", "$tile_goldwall$", "Back Wood Wall\nCheap extra support");
		//AddRequirement(b.reqs, "blob", "mat_wood", "Wood", BuilderCosts::back_wood_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_glass, "stone_block", "$tile_glass$", "Stone Block\nBasic building block");
		//AddRequirement(b.reqs, "blob", "mat_stone", "Stone", BuilderCosts::stone_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_bglass, "back_wood_block", "$tile_bglass$", "Back Wood Wall\nCheap extra support");
		//AddRequirement(b.reqs, "blob", "mat_wood", "Wood", BuilderCosts::back_wood_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_vine, "back_wood_block", "$tile_vine$", "Back Wood Wall\nCheap extra support");
		//AddRequirement(b.reqs, "blob", "mat_wood", "Wood", BuilderCosts::back_wood_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_newrubble, "back_wood_block", "$tile_vine$", "Back Wood Wall\nCheap extra support");
		//AddRequirement(b.reqs, "blob", "mat_wood", "Wood", BuilderCosts::back_wood_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_window, "back_wood_block", "$tile_vine$", "Back Wood Wall\nCheap extra support");
		//AddRequirement(b.reqs, "blob", "mat_wood", "Wood", BuilderCosts::back_wood_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_paper, "back_wood_block", "$tile_vine$", "Back Wood Wall\nCheap extra support");
		//AddRequirement(b.reqs, "blob", "mat_wood", "Wood", BuilderCosts::back_wood_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_framedrubble, "back_wood_block", "$tile_vine$", "Back Wood Wall\nCheap extra support");
		//AddRequirement(b.reqs, "blob", "mat_wood", "Wood", BuilderCosts::back_wood_block);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(CMap::tile_oldstonebackground, "back_wood_block", "$tile_vine$", "Back Wood Wall\nCheap extra support");
		//AddRequirement(b.reqs, "blob", "mat_wood", "Wood", BuilderCosts::back_wood_block);
		blocks[0].push_back(b);
	}
	{
