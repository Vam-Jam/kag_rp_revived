...
void LoadDefaultGUI()
{
	if (v_driver > 0)
	{
		...
		// blocks
		AddIconToken("$tile_stonewall$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_stonewall);
		AddIconToken("$tile_stonebackground$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_stonebackground);
		AddIconToken("$tile_woodwall$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_woodwall);
		AddIconToken("$tile_woodbackground$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_woodbackground);
		AddIconToken("$tile_copperwall$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_copperwall);
		AddIconToken("$tile_goldwall$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_goldwall);
		AddIconToken("$tile_glass$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_glass);
		AddIconToken("$tile_bglass$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_bglass);
		AddIconToken("$tile_vine$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_vine);
