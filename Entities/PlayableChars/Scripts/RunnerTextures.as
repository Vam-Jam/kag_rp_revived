...
shared class RunnerTextures
{
	...
	RunnerTextures(string shortname, string texture_prefix)
	{
		...
		//string raceName = raceName(team_num);
...
string raceName(u8 teamNumber)
	{
		CRules@ rules = getRules();
		switch(teamNumber)
		{
			case 0: 
				return(rules.get_string("Team0"));

			case 1: 
				return(rules.get_string("Team1"));

			case 2:
				return(rules.get_string("Team2"));

			case 3:
				return(rules.get_string("Team3"));
		}
		return "";
	}